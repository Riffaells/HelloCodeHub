...
data class Paradigms(val paradigms: List<Int>) {
    ...
    fun getStringParadigms(array:List<String>) = getParadigms(paradigms, array)


    companion object {

        fun getParadigms(paradigms: List<Int>, array: List<String>): List<String> {
            return paradigms.map { index ->
                array[index-1]
            }
        }
